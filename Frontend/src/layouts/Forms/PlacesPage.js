...
export default function Places() {
  ...
  const [AreaPage, setAreaPage] = useState([
    ["ז''י", "קסטינה", "מחנה בר-לב"],
    ["צפון", "חיפה", "טבריה", "נימרה"],
    ["מרכז", "תל השומר", "צריפין", "תל אביב", "פתח תקווה"],
    ["דרום", "אילת"],
  ]);
  ...
  //   axios
  //     .post(`http://localhost:5000/toraHeilit/update`, requestData)
  //     .then((response) => {
  //       setData({
  //         ...data,
  ...
  const SendFormData = (event) => {
    const allArea = {
      zroaYebasha: AreaPage[0],
      // namezroaYebasha: AreaPage[0].name,
      north: AreaPage[1],
      center: AreaPage[2],
      south: AreaPage[3],
    };
                  ...
                  <FormGroup>
                    ...
                    >
                      <MDAlert mt={-5} dir="rtl" sx={{ alignItems: "stretch" }} color="mekatnar">
                        <Icon fontSize="small">explore</Icon>
                      ...
                      <Grid xs={3} my={2} container direction="column">
                        <MDTypography variant="subtitle2">הוסף מקום:</MDTypography>
                        <Input
                          name="numPages"
                          type="string"
                          min="1"
                      ...
                      {/* <Grid container direction="column" justifyContent="end" alignItems="end">
                        <Link to={`/AreaPage/${Area.url}`} key={Area.url}>
                          <MDButton variant="outlined" color="mekatnar">
                            הוסף אזור <Icon fontSize="small">add_circle_outline</Icon>&nbsp;
                          </MDButton>
                        </Link>
                      </Grid> */}
                      {/* <MDButton
